#!/bin/bash
#SBATCH --job-name=Bedroom-v1001_Final_testing
#SBATCH --partition=long
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_output/bedroom_v1001_Final_Part9_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_error/bedroom_v1001_Final_Part9_job_error-%j.txt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
python -m infinigen.datagen.manage_jobs \
    --output_folder outputs/Bedroom_v1001_Final_testing \
    --overwrite \
    --num_scenes 1000 \

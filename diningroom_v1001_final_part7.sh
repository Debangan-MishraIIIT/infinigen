#!/bin/bash
#SBATCH --job-name=DiningRoom-v1001_Final_Part7
#SBATCH --partition=long
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/infinigen_debang/slurm_logs_output/diningroom_v1001_Final_Part7_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/infinigen_debang/slurm_logs_error/diningroom_v1001_Final_Part7_job_error-%j.txt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1

#!/bin/bash
#SBATCH --job-name=DiningRoom-v101
#SBATCH --partition=long
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_output/diningroom_v101_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_error/diningroom_v101_job_error-%j.txt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
python -m infinigen.datagen.manage_jobs \
    --output_folder outputs/DiningRoom_v101 \
    --num_scenes 10000 \

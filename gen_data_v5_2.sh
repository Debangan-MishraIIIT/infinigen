#!/bin/bash
#SBATCH --job-name=CSI-v5-2
#SBATCH --partition=long
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_output/csi_v5_2_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_error/csi_v5_2_job_error-%j.txt
#SBATCH --ntasks=1
...
python -m infinigen.datagen.manage_jobs \
    --output_folder outputs/csi_v5_6 \
    --num_scenes 400 \

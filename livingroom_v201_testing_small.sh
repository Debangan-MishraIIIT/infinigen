...
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_output/living_room_v201_testing_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_error/living_room_v201_testing_job_error-%j.txt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
python -m infinigen.datagen.manage_jobs \
    --output_folder outputs/LivingRoom_v201_testing_60 \
    --num_scenes 400 \
    ...
    --overrides \
        ...
        restrict_solving.restrict_child_primary=[\"Desk\"] \
        restrict_solving.restrict_child_secondary=[\"Lighting\"] \
    --pipeline_configs \

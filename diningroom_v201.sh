#!/bin/bash
#SBATCH --job-name=DiningRoom-v201
#SBATCH --partition=long
#SBATCH -c 48
#SBATCH --output=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_output/diningroom_v201_job_output-%j.txt
#SBATCH --error=/network/scratch/a/ankur.sikarwar/infinigen/slurm_logs_error/diningroom_v201_job_error-%j.txt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
python -m infinigen.datagen.manage_jobs \
    --output_folder outputs/DiningRoom_v201_Part1 \
    --num_scenes 1000 \
